package com.example.herve.baseapp.base.theme;
...
import com.herve.library.commonlibrary.BuildConfig;
import com.herve.library.commonlibrary.dialog.LoadingDialog;
import com.herve.library.commonlibrary.utils.BaseSPManager;
import com.herve.library.commonlibrary.utils.LanguageUtil;
...
public class BaseDelegate {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    LogUtils.d(
        "SP 语言=" + mLanguage.getLanguage() + "  " + mLanguage.getCountry());
  ...
  public void checkScreenOrientation() {
    ...
    if (mOrientationPortrait && mActivity.getRequestedOrientation() !=
  ...
  private boolean isTranslucentOrFloating() {
    ...
    try {
      int[] styleableRes =
          (int[]) Class.forName("com.android.internal.R$styleable").getField(
              "Window").get(null);
      final TypedArray ta = mActivity.obtainStyledAttributes(styleableRes);
      Method m = ActivityInfo.class.getMethod("isTranslucentOrFloating",
          TypedArray.class);
