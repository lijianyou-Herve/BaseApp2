...
public class ExceptionHelper {
    ...
    public static String handleException(Throwable e) {
        ...
        if (e instanceof SocketTimeoutException) {//网络超时
            ...
            LogNet.e("非法的参数异常: " + e.getMessage());
            error = "非法的参数异常";
        } else {//未知错误
            try {
                LogNet.e("错误: " + e.getMessage());
            } catch (Exception e1) {
                LogNet.e("未知错误Debug调试 ");
            }
            error = "错误";
        }
        return error;
