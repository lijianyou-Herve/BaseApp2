...
public class SPUtil {
    ...
    public static void putSerializableObject(String key, Object object) {
        ...
        if (!(object instanceof Serializable)) {
            throw new RuntimeException(
                    "SharedPreferences save bean need implements Serializable");
        }
        try {
            ...
            //将序列化的数据用Base64加密
            String base64Str =
                    Base64.encodeToString(bos.toByteArray(), Base64.NO_PADDING);
            //保存该16进制数组
            put(key, base64Str);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static Object get(String key, @NonNull Object defaultObject) {
        ...
        if (defaultObject instanceof String) {
            ...
            throw new RuntimeException(
                    "The default value defaultObject not be null,you must define Class type");
        }
    }
