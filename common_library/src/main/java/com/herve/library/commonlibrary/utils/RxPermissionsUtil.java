...
public class RxPermissionsUtil {
  ...
  public static Observable<Boolean> request(FragmentActivity activity,
      String... permissions) {
    return new RxPermissions(activity).request(permissions);
  }

  public static Observable<Boolean> shouldShowRequestPermissionRationale(
      FragmentActivity activity, String... permissions) {
    return new RxPermissions(activity).shouldShowRequestPermissionRationale(
        ...
        .subscribe(new Consumer<Permission>() {
          ...
          public void accept(Permission permission) throws Exception {
            if (permission.granted) {//已获取权限
              ...
              showPermissionDialog(activity, "", title,
   ...
   * 提示缺少什么权限的对话框
   */
  public static void showPermissionDialog(Context context, String title,
      String message,
